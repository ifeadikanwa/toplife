...
void main() {
  test(
      "All jobs in communications jobs list is a communication job and fulltime",
      () {
    for (var job in CommunicationsJobs.list) {
      expect(job.jobType, JobType.communication.name,
