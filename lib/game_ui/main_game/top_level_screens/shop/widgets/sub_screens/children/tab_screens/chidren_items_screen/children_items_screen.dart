...
import 'package:toplife/game_ui/main_game/top_level_screens/shop/widgets/helper_widgets/items_list_screen.dart';
...
class ChildrenItemsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Item> childrenItemsList = Shop.babyItemsList;
