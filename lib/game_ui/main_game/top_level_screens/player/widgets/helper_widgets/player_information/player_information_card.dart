...
import 'package:toplife/game_ui/main_game/top_level_screens/player/widgets/helper_widgets/player_information/player_information_card_view_model.dart';
...
class PlayerInformationCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final playerInformationViewModel =
        ref.watch(playerInformationCardViewModelProvider);

    return playerInformationViewModel.when(
