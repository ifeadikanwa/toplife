...
import 'package:toplife/core/common_states/watch/relationship/relationship_tabs/partners_tab_relationships_provider.dart';
...
class PartnersScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final dataProvider = ref.watch(partnersTabRelationshipsProvider);
