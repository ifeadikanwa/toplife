...
class $GameTableTable extends GameTable with TableInfo<$GameTableTable, Game> {
  ...
  late final GeneratedColumn<int> currentPlayerID = GeneratedColumn<int>(
      'current_player_i_d', aliasedName, true,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
  ...
  Game map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Game(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      currentPlayerID: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}current_player_i_d']),
...
class Game extends DataClass implements Insertable<Game> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    if (!nullToAbsent || currentPlayerID != null) {
  ...
  GameTableCompanion toCompanion(bool nullToAbsent) {
    return GameTableCompanion(
      id: Value(id),
      currentPlayerID: currentPlayerID == null && nullToAbsent
          ? const Value.absent()
  ...
  Game copyWith(
          {int? id,
          Value<int?> currentPlayerID = const Value.absent(),
          bool? isActive,
          int? lastPlayedTime,
          int? currentDay,
      ...
      Game(
        id: id ?? this.id,
        currentPlayerID: currentPlayerID.present
