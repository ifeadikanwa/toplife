...
part 'past_family_tab_relationships_provider.g.dart';

//ONLY LIVING PEOPLE RELATIONSHIPS
@riverpod
Stream<NoSection<PersonRelationshipPair>> pastFamilyTabRelationships(
    PastFamilyTabRelationshipsRef ref) async* {
  //watch player id
