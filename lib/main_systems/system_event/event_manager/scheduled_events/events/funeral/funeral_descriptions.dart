...
class FuneralDescriptions {
  static String getRandomFirstPersonFuneralDescription(String gender) {
    ...
    return toBeginningOfSentenceCase(
            funeralDescription[Random().nextInt(funeralDescription.length)]) ?? funeralDescription[Random().nextInt(funeralDescription.length)];
  }
  ...
  static String getRandomFirstPersonPartnerExcuse(String gender) {
    ...
    return firstPersonFuneralPartnerExcuses[Random().nextInt(firstPersonFuneralPartnerExcuses.length)];
  }
}
