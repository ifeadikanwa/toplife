...
class PartyEventDescriptions {
  ...
  static String getRandomFirstPersonBadGiftReaction(String gender) {
    ...
    List<String> badGiftReaction = [
      "I am not sure but it looked liked ${genderEnum.objectPronoun} smile dropped when ${genderEnum.subjectPronoun} opened my gift",
  ...
  static String getRandomFirstPersonPartnerExcuse(String gender) {
    ...
    return toBeginningOfSentenceCase(firstPersonPartyPartnerExcuses[
            Random().nextInt(firstPersonPartyPartnerExcuses.length)]) ??
        firstPersonPartyPartnerExcuses[
            Random().nextInt(firstPersonPartyPartnerExcuses.length)];
  }
}
