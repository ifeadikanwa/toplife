...
class ApplyToNursingSchoolUsecase {
  ...
  Future<SchoolApplicationResponse> execute({
    ...
    //if the player already has a nursing degree,reject.

    //To get a nursing degree you need at least a B in any science discipline
    ...
    List<School> completedNursingSchool = await _schoolRepositories
        .schoolRepositoryImpl
        .getAllCompletedSchoolForADegree(mainPersonID, degreeRecord.id!);

    if (completedNursingSchool.isNotEmpty) {
