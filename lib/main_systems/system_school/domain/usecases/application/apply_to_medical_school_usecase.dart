...
// }) async {
//   //if the player already has a medical degree,reject.
//
//   //To get a medical degree you need at least a B in any science discipline
//
...
//
//   List<School> completedMedicalSchool = await _schoolRepositories
//       .schoolRepositoryImpl
//       .getAllCompletedSchoolForADegree(mainPersonID, degreeRecord.id);
//
//   if (completedMedicalSchool.isNotEmpty) {
