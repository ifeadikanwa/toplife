...
class AdmitIntoPharmacySchoolUsecase {
  ...
  const AdmitIntoPharmacySchoolUsecase({
...
//     mainPersonId: mainPersonID,
//     name: "${getRandomSchoolName()} ${SchoolType.pharmacySchool.schoolNameSuffix}",
...
//     totalSemesterNumber: SchoolInfo.pharmacySchoolTotalSemesters,
//     currentSemesterNumber: SchoolInfo.firstSemester,
//     schoolType: SchoolType.pharmacySchool.name,
