...
class AdmitIntoTeacherEducationProgramUsecase {
  ...
  Future<School> execute(
    ...
    final School teacherEducationProgram = School(
      id: DatabaseConstants.dummyId,
      mainPersonId: mainPersonID,
      name: "${getRandomSchoolName()} ${SchoolType.teacherEducationProgram.schoolNameSuffix}",
      ...
      totalSemesterNumber: SchoolInfo.teacherSchoolTotalSemesters,
      currentSemesterNumber: SchoolInfo.firstSemester,
      schoolType: SchoolType.teacherEducationProgram.name,
    ...
    final createdSchool = await _schoolRepositories.schoolRepositoryImpl
        .createSchool(teacherEducationProgram);
