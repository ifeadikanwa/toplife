...
class GetAllActivePartnersUsecase {
  ...
  const GetAllActivePartnersUsecase(
  ...
  Future<List<PersonRelationshipPair>> execute({
    ...
    final List<Relationship> allActivePartnerRelationships =
        await _relationshipRepository.getAllActivePartnersOf(personID);

    //return person relationship pairs
    return _getPersonRelationshipPairsFromRelationshipsUsecase.execute(
      mainPersonId: personID,
      relationships: allActivePartnerRelationships,
