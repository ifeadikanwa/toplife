...
abstract class $AppRouter extends _i43.RootStackRouter {
  ...
  final Map<String, _i43.PageFactory> pagesMap = {
    ...
    PlayerEmptyRouter.name: (routeData) {
      return _i43.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i25.PlayerEmptyRouterScreen(),
      );
    },
    ...
    RelationshipEmptyRouter.name: (routeData) {
      return _i43.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i30.RelationshipEmptyRouterScreen(),
      );
    },
    ...
    ShopEmptyRouter.name: (routeData) {
      return _i43.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i34.ShopEmptyRouterScreen(),
      );
    },
    ...
    WorkEmptyRouter.name: (routeData) {
      return _i43.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i41.WorkEmptyRouterScreen(),
      );
    },
...
class GameManagerRoute extends _i43.PageRouteInfo<void> {
  const GameManagerRoute({List<_i43.PageRouteInfo>? children})
      : super(
