  ...
  Future<void> execute({
    ...
    if (npcUnionInfo != null) {
      ...
      final String introString =
          "Broken family ties after the end of the marriage between $familyMemberNameAndLabel and ${npcUnionInfo
          .outsiderSpouse.firstName} ${npcUnionInfo.outsiderSpouse
          .lastName}:\n";
