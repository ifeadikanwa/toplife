...
class GetAllRelationshipsInvolvingUsecase {
  ...
  const GetAllRelationshipsInvolvingUsecase(
  ...
  Future<List<PersonRelationshipPair>> execute({
    ...
    final List<Relationship> allRelationshipsInvolvingPerson =
        await _relationshipRepository.getAllRelationshipsInvolving(personID);

    //return person relationship pairs
    return _getPersonRelationshipPairsFromRelationshipsUsecase.execute(
      mainPersonId: personID,
      relationships: allRelationshipsInvolvingPerson,
