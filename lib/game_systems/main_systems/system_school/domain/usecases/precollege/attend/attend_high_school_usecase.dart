...
import 'package:toplife/game_systems/main_systems/system_school/util/school_text.dart';

class AttendHighSchool {
  ...
  Future<void> execute({
    ...
    //Player can only attend if the current precollege is high school
    if (precollegeInfo != null &&
        precollegeInfo.schoolType == SchoolType.highSchool) {
